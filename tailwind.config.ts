  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "dark-hero": "linear-gradient(to bottom, rgba(20,20,32,0.4) 0%, rgba(20,20,32,0.65) 60%, rgba(20,20,32,0.92) 100%)",
        "dark-card": "linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0.01) 100%)",
      },
      boxShadow: {
        ...
        "dark-card": "0 4px 24px rgba(0,0,0,0.4), 0 1px 4px rgba(0,0,0,0.2)",
      },
      borderRadius: {
        "4xl": "2rem",
        "5xl": "2.5rem",
